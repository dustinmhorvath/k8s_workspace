...
KUBECONFIG=./kubeconfig argocd app create app-toplevel --repo https://github.com/dustinmhorvath/k8s_workspace.git --path deployments/argo --dest-server https://kubernetes.default.svc --dest-namespace argocd
