...
variable "iso_url" {
  type    = string
  #default = "cephfs:iso/Rocky-8.10-x86_64-dvd1.iso"
  #default = "cephfs:iso/Rocky-10.0-x86_64-minimal.iso"
  #default = "cephfs:iso/CentOS-Stream-10-latest-x86_64-dvd1.iso"
  #default = "cephfs:iso/CentOS-Stream-10-latest-x86_64-boot.iso"
  default = "cephfs:iso/Rocky-9.6-x86_64-dvd.iso"
}
...
source "proxmox-iso" "autogenerated_1" {
  boot_command            = ["<tab> text inst.ks=http://{{ .HTTPIP }}:{{ .HTTPPort }}/rocky8.ks<enter>"]
  cloud_init              = "true"
  cloud_init_storage_pool = "ceph-rbd"
...
build {
  ...
  provisioner "ansible" {
    ...
    use_proxy = "false"
		user = "root"
		ssh_host_key_file = "/root/keys/id_rsa.pub"
    ansible_env_vars = [
